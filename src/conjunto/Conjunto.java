...
public class Conjunto {
    ...
    public int mayor() {
        if (this.vacio()) {  // Si el conjunto está vacío, no hay mayor valor
            return -1;
        }
        Nodo actual = inicio;
        int mayor = actual.getDato();
        while (actual != null) {  // Recorrer la lista para encontrar el mayor valor
    ...
    public boolean equals(Conjunto conjunto) {
        if (conjunto == null || !(conjunto instanceof Conjunto)) {
            return false;
        }
